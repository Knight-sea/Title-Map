...
export function createPlayer(name,title,color,memo){const s=getState(),id=generateId(),p={id,name:name||'新しいプレイヤー',title:title||'',color:color||{hue:0,shade:2},memo:memo||''};s.players.set(id,p);return p;}
